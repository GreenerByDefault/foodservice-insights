 ...
 * the placeholder user from `pnpm seed`. When Supabase Auth lands, redo this to read the auth cookie
 * and validates the JWT instead — nothing downstream changes.
 *
