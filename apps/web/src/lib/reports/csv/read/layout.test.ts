...
describe('readLayout', () => {
  describe('picking the delimiter', () => {
  ...
  describe('locating the header row', () => {
  ...
  describe('a bad header', () => {
    test('reports the fields it saw, for a header missing a required column', () => {
    ...
    test('reports an ambiguous column, not just a missing one', () => {
  ...
  describe('a file that cannot be parsed at all', () => {
