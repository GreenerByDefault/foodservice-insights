 ...
 *
 * Exported for `excel/describe.ts`, which names the same columns when no sheet of a workbook
 * holds them. The vocabulary has to move as one.
 */
export function headerLabel(column: RequiredColumn): string {
