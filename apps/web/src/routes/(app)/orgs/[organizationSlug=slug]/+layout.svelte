...
const sections = $derived(
  [
    { label: 'Reports', href: organizationHref(data.organization.slug), adminOnly: false },
    { label: 'Members', href: organizationMembersHref(data.organization.slug), adminOnly: false },
    { label: 'Settings', href: organizationSettingsHref(data.organization.slug), adminOnly: true },
