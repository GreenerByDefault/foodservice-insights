 ...
 * else is a 404 rather than a leak. Order charts by `created_at` — the worker's insert order is the
 * only ordering there is, as `result_file` has no ordinal column.
 *
