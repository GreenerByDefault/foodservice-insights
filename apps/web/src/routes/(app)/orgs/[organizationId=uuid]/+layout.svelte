...
// Reports live at the organization's root rather than under `reports/`, so that tab owns the root
// itself as well as everything beneath `reports/`.
...
<!-- The organization's own sections. The switcher is not here: it belongs to the shell above, so
     that it works on `/account` too. -->
